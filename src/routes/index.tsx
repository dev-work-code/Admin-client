...
const DriverDetails = lazy(
  () => import('@/components/internal/Ambulance/DriverDetails')
);
const RegisterScreen = lazy(
  () => import('@/components/internal/AuthComponent/Register/RegisterScreen')
);
const DoctorDetailsPage = lazy(
  () => import('@/components/internal/Doctor/DoctorDetailsPage')
);
const DoctorProfileStatusComponent = lazy(
  () => import('@/components/internal/Doctor/DoctorReject')
);
const MapPage = lazy(
  () => import('@/components/internal/Faclities/Maps/MapPage')
);
const PatientProfile = lazy(
  () => import('@/components/internal/Hospitals/HospitalProfile/PatientProfile')
);
const LiveCaseProfile = lazy(
  () =>
    import('@/components/internal/LiveCases/LiveCasesProfile/LiveCaseProfile')
);
const AdRoleForm = lazy(() => import('@/components/internal/Roles/AddRoles'));
const RoleProfile = lazy(
  () => import('@/components/internal/Roles/ProfilePage')
);
  ...
  const privateRoutes = [
    {
      ...
      children: [
        ...
        },
        {
          ...
          element: (
            <ProtectedRoute element={<DoctorProfileStatusComponent />} />
          ),
        },
        {
